...
// klaar!
 // ==========================================
const resultloop = ["loop...", "klaar!"];
for (let i = 0; i < 4; i++) {
    console.log(resultloop[0])}

for (let i = 0; i < 1; i++) {
    console.log(resultloop[1])
}
...
// .... etc.
// 15 is oneven
const resulteven = ["even", "oneven"]
for (let i = 0; i < 15; i++) {
    if (i%2 === 0) {
        console.log(i + " is " + resulteven[0]);
    } else {
        console.log(i + " is " + resulteven[1]);
    }}
